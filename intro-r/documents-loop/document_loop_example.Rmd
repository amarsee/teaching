...
`r d` is a school district serving `r state_profile[state_profile$District == d, ]$Enrollment` students. Its expenditures in 2015 were `r paste0("$", sprintf("%.2f", state_profile[state_profile$District == d, ]$Per_Pupil_Expenditures))` per student.
