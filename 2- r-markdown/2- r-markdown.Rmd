...
Click the **Knit** button to produce the document.
...
When you knit the document, this will turn into:
...
If output is a Word document, use an existing Word document (located in your working directory) as a template to specify:
