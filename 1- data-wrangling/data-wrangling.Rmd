...
> * The second is the column(s) you want to convert your data frame wide by. The values of that column will become column names
> * The third is the column(s) of values that will populate the cells in your new columns.
